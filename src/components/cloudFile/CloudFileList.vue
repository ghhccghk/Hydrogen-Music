...
<template>
  <div class="file-container">
    <div class="file-list" :class="{'file-list-selected': selectedSongs.length != 0}">
      <div v-for="(item, index) in cloudSongs" class="list-item" @dblclick="play(item.simpleSong.id, index)">
        <div class="item-info">
        ...
        <div :class="{'item-check-selected': (selectedSongs || []).findIndex((song) => song.id == item.simpleSong.id) != -1}"
             class="item-check"
             @click="fileEdit(item.simpleSong)">
          <svg class="icon" height="200" p-id="1965" t="1671452723182" version="1.1"
               viewBox="0 0 1498 1024" width="200" xmlns="http://www.w3.org/2000/svg">
            <path
    ...
    <div class="file-edit" :class="{'file-edit-selected': selectedSongs.length != 0}">
      <div class="edit-item" @click="clearSelect()">
        <svg class="icon" height="200" p-id="6239" t="1669029682779" version="1.1"
      ...
      <div class="edit-item" @click="downloadFile()">
        <svg class="icon" height="200" p-id="10347" t="1669030443895" version="1.1"
             viewBox="0 0 1024 1024" width="200" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <div class="edit-item" @click="deleteFileConfirm()">
        <svg class="icon" height="200" p-id="11464" t="1669033713486" version="1.1"
             viewBox="0 0 1024 1024" width="200" xmlns="http://www.w3.org/2000/svg">
          <path
