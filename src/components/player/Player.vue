  ...
  <div class="player-container">
    <div class="player">
      <div class="player-cover">
        <div :class="{ 'cover-change': playerChangeSong, 'back-Video': videoIsPlaying }" class="cover"
             @click="backToVideo()">
      ...
      <div class="player-info">
        <div class="info-music">
          <div :class="{ 'music-name-lable-in': playerChangeSong }" class="music-name-lable"></div>
          <span :class="{ 'music-name-in': playerChangeSong }" class="music-name">{{
              songList?.[currentIndex]?.name || songList?.[currentIndex]?.localName || '加载中...'
            }}</span>
        </div>
        <div class="info-music">
          <div :class="{ 'music-author-lable-video': videoIsPlaying || coverBlur }" class="music-author-lable"></div>
          <div class="music-author">
                        ...
                        >
                            {{
                            singer.name || ''
                          }}{{ index == (songList?.[currentIndex]?.ar?.length || 0) - 1 ? '' : ' / ' }}
                        </span>
          </div>
        </div>
      </div>
      <div class="player-control">
        ...
        <div class="control">
          <svg fill="none" height="200" viewBox="0 0 200 200"
               width="200" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" @click="playLast()">
            <defs>
            ...
            <g opacity="1" transform="translate(0 0)  rotate(0 100 100)">
              ...
              <g mask="url(#bg-mask-0)">
                ...
                <path
                  ...
                  transform="translate(152 24)  rotate(0 0.0005 76)"
                />
                <path id="line1" d="" opacity="1" style="fill: #000000"
                      transform="translate(48 24)  rotate(0 0.0005 76)"/>
                <path id="line1" d="M0,0L0,152 "
                      style="stroke: currentColor; stroke-width: 8; stroke-opacity: 1; stroke-dasharray: 0 0" transform="translate(48 24)  rotate(0 0.0005 76)"/>
              </g>
            </g>
          </svg>
          <svg
          ...
          >
            ...
            <g opacity="1" transform="translate(0 0)  rotate(0 100 100)">
              ...
              <g mask="url(#bg-mask-0)">
                <path id="三角形 1" d="M11.79,132L164.21,132L88,0L11.79,132Z " fill-rule="evenodd"
                      opacity="0" style="fill: #cccccc"
          ...
          <svg fill="none" height="200" viewBox="0 0 200 200"
               width="200" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" @click="playNext()">
            <defs>
              <rect id="path_0" height="200" width="200" x="0" y="0"/>
            </defs>
            <g opacity="1" transform="translate(0 0)  rotate(0 100 100)">
      ...
      <div class="song-control">
        ...
        <!-- 下载：本地歌曲不显示 -->
        <svg v-if="songList?.[currentIndex]?.type !== 'local'" class="icon" height="200" p-id="5311"
             t="1669445939818" version="1.1" viewBox="0 0 1024 1024" width="200" xmlns="http://www.w3.org/2000/svg"
             @click="download()">
          <path
        ...
        <!-- 添加到歌单：本地与电台均不显示 -->
        <svg v-if="!isDjMode && (songList?.[currentIndex]?.type !== 'local')" class="icon" height="200"
        ...
        <!-- 播放列表 -->
        <svg class="icon" height="200" p-id="15157" t="1668787624519"
             version="1.1" viewBox="0 0 1024 1024" width="200" xmlns="http://www.w3.org/2000/svg" @click="playlistWidgetShow = !playlistWidgetShow">
          <path
    ...
    <PlayList :class="{ 'playlist-widget-open': playlistWidgetShow }" class="playlist-widget-player"></PlayList>
