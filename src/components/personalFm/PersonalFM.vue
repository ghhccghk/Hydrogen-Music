<template>
  <div class="personal-fm">
    ...
    <div v-if="currentSong && !loading" class="fm-content">
      <div class="fm-main">
        <div class="fm-cover" @click="togglePlay">
          <img :alt="currentSong.name" :src="currentSong.album?.picUrl || '/src/assets/default-cover.png'"/>
          <div class="fm-play-overlay">
            <svg v-if="!isPlaying" fill="white" height="40" viewBox="0 0 24 24" width="40">
              <path d="M8 5v14l11-7z"/>
            </svg>
            <svg v-else fill="white" height="40" viewBox="0 0 24 24" width="40">
      ...
      <div class="fm-actions">
        <div class="action-btn prev" title="上一首" @click="prevSong">
          <svg fill="currentColor" height="20" viewBox="0 0 24 24" width="20">
            <path d="M6 6h2v12H6zm3.5 6l8.5 6V6z"/>
          </svg>
        </div>

        <div class="action-btn trash" title="不喜欢" @click="trashSong">
          <svg fill="currentColor" height="20" viewBox="0 0 24 24" width="20">
            <path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/>
          </svg>
        </div>

        <div :class="{ active: isCurrentSongLiked }" class="action-btn like" title="喜欢" @click="likeSong">
          <svg fill="currentColor" height="20" viewBox="0 0 24 24" width="20">
            <path
        ...
        <div class="action-btn next" title="下一首" @click="nextSong">
          <svg fill="currentColor" height="20" viewBox="0 0 24 24" width="20">
    ...
    <div v-else-if="loading" class="fm-loading">
