  ...
  <div class="radio-intro">
    <div class="intro-header">
      ...
      <div class="meta">
        ...
        <div class="sub">{{ djName }}<span v-if="djName && (programCount || subCount)" class="dot">·</span><span
          v-if="programCount">{{ programCount }} 期</span><span v-if="subCount"> · {{ subCount }} 订阅</span></div>
      </div>
    </div>
