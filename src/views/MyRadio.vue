    ...
    <div class="radio-content">
      ...
      <div v-else class="radio-grid">
        ...
        >
          ...
          <div class="meta">
            <div :title="radio.name" class="name">{{ radio.name }}</div>
            <div class="sub">
              <span v-if="radio.dj?.nickname" class="dj">{{ radio.dj.nickname }}</span>
              <span v-if="radio.dj?.nickname && (radio.programCount || radio.subCount)" class="sep">·</span>
